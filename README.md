...
Personal study archive of the **App Mafia — 0 to $100k Course** (Whop), extracted from each video's English captions.
...
- This is a personal study archive of caption-derived transcripts, not a redistribution of the paid course videos.
- Source course (membership required): Whop App Mafia course page referenced in `manifest.json` → `sourceUrl`.
